      ...
      if ($scope.form.theForm.$valid) {
        ...
        register.saveDealar({}, $scope.userData, function (data) {
          if(data.statusCode === 200){
            ...
            $scope.userData = {};
            Materialize.toast('<span>' + "We have sent you an email in the email ID you just used. Please click on the verification link on the email to verify your account." + '</span>', 5000);
          }
          else {
